...
/**
 * Not actually made yet, need to conference with group members
 */
...
public class EventServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
          ...
          String owner = getStringFromParameter(req.getParameter("Business"));	//May not work
          ...
          if (name == null || start < 1010001 || end < 1010001) { // (01-01-0001) the first day.
            ...
            req.setAttribute("Business", owner);
            ...
            if(controller.AddEvent(name, description, start, end, owner)){
